...
public class ProductController {
    ...
    @GetMapping("/search/productsbypricerange")
    public ResponseEntity<List<ProductDto>> findProductsByPriceRange(@RequestParam int minPrice,
            @RequestParam int maxPrice) {
        List<ProductDto> result = productService.findProductsByPriceRange(minPrice, maxPrice);
        return ResponseEntity.ok(result);
    }
